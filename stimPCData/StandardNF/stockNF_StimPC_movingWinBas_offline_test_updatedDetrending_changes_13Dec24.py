...
The images order for the localiser and the NF runs should also be provided in the ./data/sub-XX/ses-0X folder.

The ./data/sub-XX/ses-0X should contain:
...
hdr, prt_data = prt.read_prt(f'{wdir}/data/{sub}/ses-0{session}/runNF{run}/runNF{run}_stock.prt')
