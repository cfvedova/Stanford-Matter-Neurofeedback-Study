...
This script creates protocols files for the TBV PC based on the stimuli order (only when dealing with stock images).

Practically, it loads the stimuli order files (of the stock images runs) for the current participant and session and creates
...
shutil.copytree(f'C:/Users/assun/Documents/GitHub/MatterNeurofeedbackStudy/TBVFile_temp/TBVFiles',f'{subdir_tbv}/TBVFiles')
