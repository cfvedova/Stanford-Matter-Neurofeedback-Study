...
Create CTR files for TBV (Standard NF)

This script creates contrast files for the TBV PC based on the generated PRT files.
Contrast files are used to define the contrast map that TBV should compute during the real-time preprocessing.
