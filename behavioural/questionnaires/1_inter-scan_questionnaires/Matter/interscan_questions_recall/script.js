...
function createQuestionnaire(instanceId) {
    ...
    heading.textContent = `Recall run ${instanceId}`;
...
function saveRatings() { // finishing saving downloading the data
    ...
    let csvContent =  'RecallRun,Question,Score\n';
    ...
    const filename = `interscan-Recall-ratings_${subjectID}_ses-0${sessionNumber}_${timestamp}.csv`;
